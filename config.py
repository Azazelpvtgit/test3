...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001559864888"))
...
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nI can store private files and other users can access it from special link. Powered By~ @Fl4me_Organization")
try:
    ADMINS=[]
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>You need to join 👇🏻 Channel to use me\n\nKindly Please join Channel Then tap on the link again u did before</b>")

#set your Custom Caption here, Keep None for Disable Custom Caption
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", None)

#set True if you want to prevent users from forwarding files from bot
PROTECT_CONTENT = True if os.environ.get('PROTECT_CONTENT', "") == "False" else False
